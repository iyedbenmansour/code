...
add_button = tk.Button(task_frame, image=add_icon, bd=0, bg="#0078d7",
                       fg="#ffffff", command=add_task, height=20, width=20)
...
delete_button = tk.Button(root, bd=0, bg="#0078d7",
                          fg="#ffffff", width=30, height=30, command=delete_task)
